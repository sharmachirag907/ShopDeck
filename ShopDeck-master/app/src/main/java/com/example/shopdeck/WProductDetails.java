...
public class WProductDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_w_product_details);
        ...
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (status.equals("Order Placed") || status.equals("Order Shipped")){
                    Toast.makeText(WProductDetails.this, "You can place more order after your order is shipped or confirmed.", Toast.LENGTH_LONG).show();
                }
                else if (TextUtils.isEmpty(Quantity)) {
                    Toast.makeText(WProductDetails.this, "Please Enter Quantity", Toast.LENGTH_SHORT).show();
                }
                else if (Quantity.length() >1){
                    Toast.makeText(WProductDetails.this, "Quantity must be less than 9", Toast.LENGTH_SHORT).show();
                }
                else if (Quantity.equals("0")){
                    Toast.makeText(WProductDetails.this, "Quantity must be greater than 0", Toast.LENGTH_SHORT).show();
                }
                else {
                    addingToCartList();
                }
                        ...
                        if (task.isSuccessful()){
                            cartListRef.child("Admin View").child(Prevalent.currentOnlineUser.getPhone())
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                Toast.makeText(WProductDetails.this, "Added to cart list", Toast.LENGTH_SHORT).show();

                                                Intent intent= new Intent(WProductDetails.this,Nav_Home.class);
                                                startActivity(intent);
                                            }
                                            else {
                                                Toast.makeText(WProductDetails.this, "Error2", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                        }
                        else {
                            Toast.makeText(WProductDetails.this, "Error1", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(WProductDetails.this, WishList.class));
